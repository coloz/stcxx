...
#define USED_HEADERS_FLAG(Name)                                                \
  ...
  USED_HEADERS_FLAG(FPClassFloat)
  USED_HEADERS_FLAG(FPClassDouble)
...
private:
  ...
  void validateSTCMemoryIntrinsic(CallInst &I, Intrinsic::ID ID);
