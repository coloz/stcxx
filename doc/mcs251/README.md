# SDCC target documentation

The complete upstream SDCC manual is maintained in
[`doc/sdccman.lyx`](../sdccman.lyx). This directory contains focused
target documentation added by the MCS-251 downstream port.

## Chinese documentation

The parallel Chinese manual covers the complete SDCC toolchain, the mature
MCS-51 port, and the MCS-251 port without changing the upstream English
manual hierarchy:

- [简体中文手册](../zh-CN/README.md)
