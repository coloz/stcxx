...
pub fn adapt(
    ...
    // CBE omits declarations supplied by these headers (for example sqrtf
    // and powf). Preserve its requested native headers when replacing the
    // preamble; the SDCC stage must use SDCC's declarations and calling ABI.
