...
check_sha fe7d5fbd4a8e2d90c88642dc8732555682d4dd7ba589cfdbb30657ea1fd9b13d "${repo_root}/arduino/bridge/audit_and_adapt.py"
check_sha 9980df2cd3d8805b33cd6aa1266984658a7e7f0676a24d47fbb6f6a82b0e7bb0 "${repo_root}/arduino/bridge/adapt.py"
check_sha 8ec60e4093e6c96593682f3e2ca68fab0651d4f069dd12f5384bf030e15bddc8 "${repo_root}/arduino/tests/check-bridge-adapter.py"
