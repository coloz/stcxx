/*-------------------------------------------------------------------------
   _heap_init.c - MCS251 heap initialization and allocator state.

   Extracted from malloc.c, Copyright (C) 2015, Philipp Klaus Krause,
   pkk@spth.de.
...
#define HEAP_END (struct header HEAPSPACE *)((char HEAPSPACE *)&__sdcc_heap + (__sdcc_heap_size32 - 1))

header_t *HEAPSPACE __sdcc_heap_free;
